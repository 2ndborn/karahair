    ...
    return (
        <motion.div ref={ref} style={{ opacity, position: "relative", backgroundImage: "linear-gradient(to bottom, #f1e7dd, #ffffff, #fff)", height: "350vh" }}>
            ...
            style={{
                ...
                zIndex: 1, backgroundColor: "lightGray",
            ...
            <motion.div style={{opacity: opacityTwo, scale, position: "sticky", top: 0, display: "flex", justifyContent: "center", alignItems: "center", height: "100vh", width: "100%", zIndex: 2}}>
                <h1>Welcome to the KARA Method:</h1>
            </motion.div>
            </div>
