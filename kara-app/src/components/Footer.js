    ...
    <footer className="bg-dark text-light py-4">
      <Container>
        <Row>
          ...
          <Col md={4}>
                <h5>Contact Me</h5>
                <p><i class="fa-solid fa-mobile-screen-button"></i> 07900 000 000</p>
                <p><i class="fa-solid fa-envelope"></i> noemail@gmal.com</p>
          </Col>
          <Col md={4}>
            <h5>Follow Me</h5>
            <div className={styles.socialMedia}>
                <a href="/" className="px-2"><i class="fa-brands fa-instagram"></i></a>
                <a href="/" className="px-2"><i class="fa-brands fa-tiktok"></i></a>
            </div>
          </Col>
        </Row>
        <Row className="mt-3">
